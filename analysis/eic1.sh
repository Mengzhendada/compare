python main.py rc col 140 0.001148 0.5 3 [0.05,0.1,0.15,0.2,0.25,0.3,0.35,0.4,0.45,0.5,0.55,0.6]&>results/Fac-results/EIC_1_col_rc.txt
python main.py born col 140 0.001148 0.5 3 [0.05,0.1,0.15,0.2,0.25,0.3,0.35,0.4,0.45,0.5,0.55,0.6]&>results/Fac-results/EIC_1_col_bn.txt
python main.py rc unpol 140 0.001148 0.5 3 [0.05,0.1,0.15,0.2,0.25,0.3,0.35,0.4,0.45,0.5,0.55,0.6]&>results/Fac-results/EIC_1_unpol_rc.txt
