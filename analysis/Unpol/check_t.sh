...
do
  ...
  ./get_cross_section 0 11.0 U U 0.4 0.48 0.5 0.16 ${f1} 1 0.01>>out.txt
  ./get_cross_section 0 11.0 U U 0.4 0.48 0.5 0.4 ${f1} 1 0.01>>out.txt
  ./get_cross_section 0 11.0 U U 0.4 0.48 0.5 0.632 ${f1} 1 0.01>>out.txt
